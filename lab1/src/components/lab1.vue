<template>
  <div class="container">
            ...
            <ul class="navbar-nav me-auto">
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="fa-solid fa-list" />Bài viết</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="fa-solid fa-film" /> Video</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="fa-solid fa-circle-info" /> Giới thiệu</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="fa-solid fa-calendar-days" /> Sự kiện</a
                >
              </li>
    ...
    <footer class="row p-3 text-center" style="background-color: grey">
      <p style="color: white">
        <i class="bi bi-c-circle" />© Copyright by FPT Polytechnic
      </p>
    </footer>
  </div>
</template>
